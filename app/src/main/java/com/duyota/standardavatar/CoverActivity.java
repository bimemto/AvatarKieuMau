...
public class CoverActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cover_maker);
    ...
    private void saveInBackground() {
        Task.callInBackground(new Callable<Void>() {
            ...
            public Void then(Task<Void> task) throws Exception {
                new MaterialDialog.Builder(CoverActivity.this).content(R.string.finished_cover).positiveText(android.R.string.ok).show();
                return null;
            }
    ...
    private void takeScreenshot() {
        try {
            ...
            String mPath = Environment.getExternalStorageDirectory().toString() + "/DCIM/Camera/" + "coverkieumau_" + System.currentTimeMillis() + ".jpg";
            ...
            values.put(MediaStore.Images.Media.TITLE, "coverkieumau_" + System.currentTimeMillis());
            values.put(MediaStore.Images.Media.DESCRIPTION, "Cover kiểu mẫu");
